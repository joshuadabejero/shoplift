...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "products__section" }, _attrs))} data-v-27b58ca5><div class="products__container" data-v-27b58ca5><div class="products__heading" data-v-27b58ca5><h1 data-v-27b58ca5>Shop Products</h1><p data-v-27b58ca5>Discover our wide range of high-quality products</p></div><div class="products__controls" data-v-27b58ca5><div class="products__text-field" data-v-27b58ca5>`);
      ...
      _push(`</div><div class="products__sort-filters" data-v-27b58ca5><div class="select__container" data-v-27b58ca5>`);
      ...
      if (showFilters.value) {
        _push(`<div class="products__categories pa-4" data-v-27b58ca5><h3 class="mb-4" data-v-27b58ca5>Categories</h3><div class="products__categories--wrapper" data-v-27b58ca5><!--[-->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-27b58ca5"]]);

export { index as default };
//# sourceMappingURL=index-DtJ0QlSt.mjs.map
