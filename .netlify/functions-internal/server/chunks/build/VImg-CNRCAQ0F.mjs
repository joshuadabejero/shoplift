import { shallowRef, ref, computed, watch, nextTick, toRef, toValue, isRef, resolveDynamicComponent, reactive, useId, provide, inject, readonly, watchEffect, createVNode, Fragment, toRefs, TransitionGroup, Transition, mergeProps, h, Text, withDirectives, toDisplayString, resolveDirective, vShow, unref } from 'vue';
import { g as genericComponent, e as propsFactory, h as getCurrentInstance, C as useTheme, D as useIcon, f as provideTheme, B as convertToUnit, k as getCurrentInstanceName, F as useRtl, H as hasEvent, z as deepEqual, m as makeThemeProps, I as IconValue, l as destructComputed, i as includes, j as templateRef, J as isObject, o as isCssColor, q as isParsableColor, s as parseColor, v as getForeground, p as provideDefaults, K as keyCodes, w as useProxiedModel, G as clamp, E as flattenFragments, A as wrapInArray, x as consoleWarn, y as findChildrenWithProvide } from './server.mjs';
...
export { useRouter as A, useResizeObserver as B, makeVariantProps as C, makeRouterProps as D, makeGroupItemProps as E, makeElevationProps as F, makeBorderProps as G, parseAnchor as H, Intersect as I, flipSide as J, flipAlign as K, LoaderSlot as L, MaybeTransition as M, flipCorner as N, getAxis as O, makeGroupProps as P, useGroup as Q, Ripple as R, useLocation as S, usePosition as T, makePositionProps as U, VBtn as V, makeLocationProps as W, makeVBtnProps as X, VIcon as a, useRender as b, makeDimensionProps as c, makeComponentProps as d, VProgressCircular as e, VImg as f, makeSizeProps as g, makeDensityProps as h, VDefaultsProvider as i, useDensity as j, useLoader as k, useRounded as l, makeTagProps as m, useBackgroundColor as n, useTextColor as o, makeTransitionProps as p, useBorder as q, useElevation as r, useSize as s, useGroupItem as t, useDimension as u, useLink as v, useVariant as w, genOverlays as x, makeRoundedProps as y, makeLoaderProps as z };
//# sourceMappingURL=VImg-CNRCAQ0F.mjs.map
