import { computed, ref, createVNode, mergeProps, Fragment, withDirectives, resolveDirective, cloneVNode, shallowRef, toRef, watch, createTextVNode, useId, vShow, nextTick, inject, provide, onScopeDispose, toDisplayString, unref, Transition, Teleport, watchEffect, reactive, toValue, toRaw, readonly } from 'vue';
import { u as useItems, V as VList, a as VListItem, b as VExpandXTransition, c as VSlideYTransition, m as makeItemsProps, d as VFadeTransition } from './VList-DYKzCXCp.mjs';
import { I as Intersect, b as useRender, a as VIcon, i as VDefaultsProvider, j as useDensity, u as useDimension, k as useLoader, l as useRounded, n as useBackgroundColor, o as useTextColor, L as LoaderSlot, M as MaybeTransition, p as makeTransitionProps, R as Ripple, q as useBorder, r as useElevation, s as useSize, t as useGroupItem, v as useLink, w as useVariant, x as genOverlays, y as makeRoundedProps, z as makeLoaderProps, d as makeComponentProps, h as makeDensityProps, c as makeDimensionProps, A as useRouter, B as useResizeObserver, C as makeVariantProps, m as makeTagProps, g as makeSizeProps, D as makeRouterProps, E as makeGroupItemProps, F as makeElevationProps, G as makeBorderProps, H as parseAnchor, J as flipSide, K as flipAlign, N as flipCorner, O as getAxis, P as makeGroupProps, Q as useGroup } from './VImg-CNRCAQ0F.mjs';
import { g as genericComponent, e as propsFactory, w as useProxiedModel, M as filterInputAttrs, P as useLocale, A as wrapInArray, z as deepEqual, a4 as ensureValidVNode, k as getCurrentInstanceName, f as provideTheme, F as useRtl, B as convertToUnit, Q as callEvent, O as omit, a5 as checkPrintable, N as matchesSelector, $ as isClickInsideElement, h as getCurrentInstance, R as useToggleScope, m as makeThemeProps, L as EventProp, I as IconValue, S as pick, a0 as focusChild, a1 as getNextElement, W as focusableChildren, U as useDisplay, a2 as debounce, G as clamp, a3 as getPropertyFromItem, j as templateRef, l as destructComputed, X as CircularBuffer, Y as consoleError, Z as defer, p as provideDefaults, T as makeDisplayProps, V as useGoTo } from './server.mjs';
import { V as VAvatar } from './VAvatar-mCO-D1Ut.mjs';
      ...
      return isActive.value && withDirectives(createVNode(Tag, mergeProps({
        ...
        default: () => {
          ...
          return [genOverlays(isClickable.value, "v-chip"), hasFilter && createVNode(VExpandXTransition, {
            ...
            disabled: props.disabled
          })) != null ? _a3 : toDisplayString(props.text)]), hasAppend && createVNode("div", {
            "key": "append",
...
export { VTextField as V, VSelect as a };
//# sourceMappingURL=VSelect-D0vjoIR3.mjs.map
