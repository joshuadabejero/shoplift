import { defineComponent as defineComponent$1, inject as inject$1, computed, toValue, Fragment, capitalize, watch, onScopeDispose, toRef, warn, isVNode, Comment, hasInjectionContext, ref, h, Suspense, getCurrentInstance as getCurrentInstance$1, provide, createElementBlock, shallowRef, reactive, watchEffect, unref, toRaw, createVNode, mergeProps, effectScope, shallowReactive, defineAsyncComponent, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isRef, isShallow, isReactive, getCurrentScope, withCtx, toRefs, nextTick, useSSRContext } from 'vue';
...
const _routes = [
  {
    name: "crud",
    path: "/crud",
    component: () => import('./crud-DsIa3uI1.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Bt3OIiTF.mjs')
  },
  {
    name: "products-id",
    path: "/products/:id()",
    component: () => import('./_id_-dJP92LTA.mjs')
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./index-DtJ0QlSt.mjs')
  }
];
...
const LazyCRUDDialog = defineAsyncComponent(() => import('./CRUDDialog-C0CND5rP.mjs').then((r) => r["default"] || r.default || r));
const LazyProductCard = defineAsyncComponent(() => import('./ProductCard-Cm0bYlZC.mjs').then((r) => r["default"] || r.default || r));
const lazyGlobalComponents = [
  ["CRUDDialog", LazyCRUDDialog],
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CROGG25J.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-1hl0BgtE.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-83bBjTW4.mjs'));
...
export { isClickInsideElement as $, wrapInArray as A, convertToUnit as B, useTheme as C, useIcon as D, flattenFragments as E, useRtl as F, clamp as G, hasEvent as H, IconValue as I, isObject as J, keyCodes as K, EventProp as L, filterInputAttrs as M, matchesSelector as N, omit as O, useLocale as P, callEvent as Q, useToggleScope as R, pick as S, makeDisplayProps as T, useDisplay as U, useGoTo as V, focusableChildren as W, CircularBuffer as X, consoleError as Y, defer as Z, _export_sfc as _, useNuxtApp as a, focusChild as a0, getNextElement as a1, debounce as a2, getPropertyFromItem as a3, ensureValidVNode as a4, checkPrintable as a5, breakpoints as a6, defineComponent as a7, deprecate as a8, isPrimitive as a9, createRange as aa, useRoute as ab, __nuxt_component_0 as ac, useRuntimeConfig as b, nuxtLinkDefaults as c, __nuxt_component_0$2 as d, entry$1 as default, propsFactory as e, provideTheme as f, genericComponent as g, getCurrentInstance as h, includes as i, templateRef as j, getCurrentInstanceName as k, destructComputed as l, makeThemeProps as m, navigateTo as n, isCssColor as o, provideDefaults as p, isParsableColor as q, resolveRouteObject as r, parseColor as s, tryUseNuxtApp as t, useRouter as u, getForeground as v, useProxiedModel as w, consoleWarn as x, findChildrenWithProvide as y, deepEqual as z };
