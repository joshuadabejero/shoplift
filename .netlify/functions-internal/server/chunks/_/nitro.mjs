...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "f8c5f35a-cbcd-4e1c-ad36-79b92b004e3a",
...
const _lazy_2Utun1 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_2Utun1, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2Utun1, lazy: true, middleware: false, method: undefined }
];
